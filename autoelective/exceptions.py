...
class AccessLimitedError(AutoElectiveException):
    """Desktop stops on an explicit HTTP access/rate restriction."""
...
class AutoElectiveClientException(AutoElectiveException):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.detail = kwargs.pop("msg", self.__class__.desc)
        msg = "[%d] %s" % (
            self.__class__.code,
            self.detail
        )
...
class UnexpectedHTMLFormat(AutoElectiveClientException):
    code = 104
